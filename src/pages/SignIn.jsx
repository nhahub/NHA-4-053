...
export default function SignIn() {
  ...
  const [password, setPassword] = useState('Waste@2026');
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 rounded-2xl border border-primary/15 bg-primary/5 p-4 text-sm text-muted-foreground">
            <p className="font-semibold text-foreground">Secure platform access only</p>
            <p className="mt-1">Use the seeded accounts from the run guide. Role shortcuts were removed so every sign-in goes through the real backend authentication flow.</p>
          </div>
